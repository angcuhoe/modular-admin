...
[![demo](https://github.com/technext/modular-admin/blob/master/src/_assets/demo.png)](http://demo.WebTheme.Top.com/preview/bootstrap-4-free-admin-template)
...
<p align="center">
  <strong>
    <a href="http://demo.WebTheme.Top.com/preview/bootstrap-4-free-admin-template" target="_blank">View Demo</a> | 
	<a href="https://www.webtheme.topthemes/bootstrap-4-free-admin-template/" target="_blank">Download ZIP</a>
  </strong>
</p>

[ModularAdmin](https://www.webtheme.top/themes/bootstrap-4-free-admin-template/) is an open source dashboard theme built in a modular way. That makes it extremely easy to scale, modify and maintain.
